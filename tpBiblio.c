...
switch(chx)
	...
	case 5 : printf("Donnez un titre à supprimer :\n");
			...
			break;
	case 6 : printf("Donner le nom du livre à emprunter :\n");
			 T_Emp E;
			 lire(titre,60);
			 printf("Donner le nom de l'emprunteur :\n");
			 lire(E.nomemprunteur, 60);
			 reponse = emprunterLivre(&B, &titre, E.nomemprunteur);
			 if(reponse == 1) 
	...
	case 10 :printf("Trier les livres (par annee)\n");
			...
			reponse = afficherBibliotheque(&B);
			break;
	case 11 : printf("Lister les livres disponibles");
			livreDisponible(&B);
			break;
	case 12 : printf("Lister les livres en retard");
			listerLivreEnRetard(&B);
	}
